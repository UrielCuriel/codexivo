  ...
  it("should create a program with let statements", () => {
    ...
    const program = new Program([
      new LetStatement(
        ...
        new Identifier(
          new Token(TokenType.IDENT, "mi_variable"),
          "mi_variable"
        ),
        new Identifier(
          new Token(TokenType.IDENT, "otra_variable"),
          "otra_variable"
        )
      ),
    ]);
  ...
  it("should create a program with return statements", () => {
    ...
    const program = new Program([
      new ReturnStatement(
        ...
        new Identifier(new Token(TokenType.IDENT, "5"), "5")
      ),
    ]);
    const programString = program.toString();
  ...
  it("should create a program with INTEGER expressions ", () => {
    ...
    const program = new Program([
      new ExpressionStatement(
        ...
        new Identifier(new Token(TokenType.INT, "5"), "5")
      ),
    ]);
